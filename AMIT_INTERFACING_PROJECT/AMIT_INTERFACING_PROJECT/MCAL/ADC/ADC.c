...
{
	ADC_CSRA = ADC_CSR_INIT_VALUE ;
	ADC_MUX = ADC0_MUX_VALUE ;
}

extern void ADC1_INIT(void)
{
	ADC_CSRA = ADC_CSR_INIT_VALUE ;
	ADC_MUX = ADC1_MUX_VALUE ;
}
...
extern void ADC0_READ(uint16_t *pu16ADC0_reading)
{
	...
	u16ADCL_reading = (unsigned int)ADC_L ;
	u16ADCH_reading = (unsigned int)ADC_H ;
...
extern void ADC0_32_READ(uint32_t *pu32ADC0_reading)
{
	...
	u32ADCL_reading = (unsigned int)ADC_L ;
	u32ADCH_reading = (unsigned int)ADC_H ;
